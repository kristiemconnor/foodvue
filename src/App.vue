        ...
        <div class="container">
            ...
            <div class="inner-navigation collapse">
                <div class="inner-navigation-inline">
                    <div class="inner-nav">
                      <ul>
                        <li class="has-submenu">  <router-link to="/">Home</router-link></li>
                        <li class="has-submenu"><router-link to="/about">About</router-link></li>
                    ...
                    <div class="extra-nav text-right">
                        <ul>
                            <li class="has-submenu submenu-left"><router-link v-if="!isLoggedIn()" to="/login">Login</router-link></li>
